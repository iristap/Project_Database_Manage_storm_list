...
<body>
    ...
    <label  class="col-form-label-lg">แก้ไขชื่อพายุที่ถูกปลด </label><br>
    ...
    <label >วันที่เริ่มเลิกใช้งาน :<input type="date" name="dateend" class="form-control"
            value="<?php echo $Storm->dateend ?>"></label><br>
